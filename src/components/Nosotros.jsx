    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-[#1a1a1a] rounded-[16px] px-8 py-8 flex flex-col gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[#cc0000] text-[26px] font-semibold">Car</span>
        ...
        <div className="flex gap-6 mt-2 pt-4 border-t border-[#2a2a2a]">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col gap-0.5">
              <span className="text-[#cc0000] text-[20px] font-semibold">{s.value}</span>
      ...
      {/* Nuestra misión */}
      <div
        className="rounded-[12px] px-6 py-5 border-l-4 border-[#cc0000] bg-white border border-[#e2e2e2]"
      >
        <h2 className="text-[13px] font-semibold text-[#cc0000] uppercase tracking-wider mb-2">
          Nuestra misión
        </h2>
